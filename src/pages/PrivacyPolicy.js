    ...
    <>
      ...
      >
        ...
        <motion.section
          ...
          // Changed amount from 0.2 to default (0) for easier triggering on mobile
          viewport={{ once: true }} // No 'amount' specified, defaults to 0
          // If this still doesn't work, consider viewport={{ amount: "all" }}
          // or removing 'once: true' for debugging if you want it to trigger every time it enters the viewport.
          // For a simpler approach, you could also use 'animate="visible"' instead of 'whileInView'
          // if you want the section to animate right after the page loads, similar to the hero.
          // animate="visible" // Use this if you want it to animate on load, not on scroll into view
